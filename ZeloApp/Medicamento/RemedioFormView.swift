...
//
//    init(initialName: String = "") { _model = State(initialValue: RemedioFormModel(name: initialName))}
//
//        var body: some View {
//            NavigationStack {
//                Form {
//                    Section {
//                        Picker("Tipo de Medicamento", selection: $model.tipo) {
...
//
//                    Section {
//                        Picker("Unidade", selection: $model.unidade) {
