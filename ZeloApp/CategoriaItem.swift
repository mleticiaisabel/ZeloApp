...
let minhasCategorias = [
    ...
    CategoriaItem(titulo: "Doenças", descricao: "Se a criança estiver doente, insira aqui o que está havendo...", icone: "cross.case.fill", corIcone: .orange, destino: .doencas),
